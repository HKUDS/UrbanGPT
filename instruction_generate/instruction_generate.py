    ...
    for region_index in range(0, data.shape[2], 1):
        ...
        if type == 2 or type == 3 or type == 4:
            if args.for_supervised or args.for_test==False:
                region_index_new = region_index + args.region_start + selected_regions[0:80][region_index]
            else:
                region_index_new = region_index + args.region_start + selected_regions[80:160][region_index]
        elif type == 1:
            if args.for_supervised or args.for_test==False:
